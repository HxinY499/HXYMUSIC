...
export default memo(function XYWangyiComment(props) {

  const com = props.comment

  const name = com ? com.user.nickname : "no nickname"
  const avatar = com ?  com.user.avatarUrl : "http://s4.music.126.net/style/web2/img/default/default_avatar.jpg?param=50y50"
